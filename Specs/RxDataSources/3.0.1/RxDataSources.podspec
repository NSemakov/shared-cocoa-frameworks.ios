...
# MARK: - iOS Static Framework
  ...
  s.source = {
    http: 'https://dl.bintray.com/roxiemobile/generic/RxDataSources+Differentiator+RxCocoa-3.0.1-Static.zip',
    sha256: '21cec89381ba160bb16fef764a411e05c2d4f9aa78f136d314e0e355cf1895db'
  }
  ...
  s.subspec 'Static' do |sc|
    ...
    # Dependencies
    sc.dependency 'Differentiator/Static', '~> 3.0.1'
